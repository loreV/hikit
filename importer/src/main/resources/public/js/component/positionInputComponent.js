var positionInputComponent = Vue.component('position-input', {
  ...
  template:
    ...
    <div class="field ">
        ...
        <div class="control ">
            <input class="input " type="text " placeholder="Text input" name="postcode"> </div>
    </div>
    <div class="field">
        <label class="label">Altitude</label>
        <div class="control">
            <input class="input" type="text" placeholder="Textinput" name="altitude">
        </div>
    </div>
    <div class="field">
        <label class="label">Latitude</label>
        <div class="control">
            <input class="input" type="text" placeholder="Text input" name="latitude">
        </div>
    </div>
    <div class="field">
    ...
    <div class="field">
        ...
        <div class="control">
            <input class="input" type="text" placeholder="Text input" name="tags"> </div>
    </div>
</div>`
})
